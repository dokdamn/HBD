...
const animationTimeline = () => {
    ...
    tl.to(".container", 0.4, { visibility: "visible" })
        ...
        .staggerTo(".hbd-chatbox span", 1, { visibility: "visible" }, 0.03)
        .to(".four", 0.4, { scale: 0.2, opacity: 0, y: -150 }, "+=0.5")
        ...
        .to(".idea-5 span", 0.5, { rotation: 90, x: 8 }, "+=0.8")
        ...
        .staggerFrom(".wish-hbd span", 0.5, { opacity: 0, y: -50, rotation: 150, skewX: "30deg", ease: Elastic.easeOut.config(1, 0.5) }, 0.08)
        .staggerFromTo(".wish-hbd span", 0.5, { scale: 1.4, rotationY: 150 }, { scale: 1, rotationY: 0, color: "#ff69b4", ease: Expo.easeOut }, 0.08, "party")
    ...
    // ✅ REMOVE REPLAY BUTTON FROM THE HTML
    const replayBtn = document.getElementById("replay");
    if (replayBtn) {
        replayBtn.remove();
    }

    // ✅ PREVENT CLICKING ANYWHERE ON THE PAGE FROM RESTARTING
